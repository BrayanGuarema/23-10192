  ...
  return (
    <div className="app-toolbar mt-2" data-bs-theme="dark">
      <div className="input-group">
        ...
        <button className="input-group-text" title={"Carousel: ..."} style={{ color: props.uxColor(4) }} onClick={props.setUX.bind(null, 4)}>Carousel</button>
        <button className="input-group-text" title={"Double Carousel: ..."} style={{ color: props.uxColor(5) }} onClick={props.setUX.bind(null, 5)}>Double Carousel</button>
        <button className="input-group-text" title={"List: ..." } style={{ color: props.uxColor(6) }} onClick={props.setUX.bind(null, 6)}>List</button>
        <text className="input-group-text flex-fill"/>
